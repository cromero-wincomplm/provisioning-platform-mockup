...
export function Header() {
    return (
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style={{ padding:'10px', width:'100%',boxShadow: '3px 2px rgb(0,0,0,0.20)'}}>
             <a class="navbar-brand" href="#"><img src={"../../../../provisioning-platform-mockup/features/reactCDN/img/wincomlogo.png"} style={{height:'45px', width:'45px'}}/></a>
...
checkImage(
    ...
    "../../../../provisioning-platform-mockup/features/reactCDN/img/wincom-logo-horizontal-dark.png",
...
export function Footer() {
    return (
        <footer className="d-flex justify-content-center " style={{marginTop:'50px'}}>
            <div>Powered by <img width='96' src={'../../../../provisioning-platform-mockup/features/reactCDN/img/wincom-logo-horizontal-dark.png'} alt="no shown" /></div>
        </footer>
